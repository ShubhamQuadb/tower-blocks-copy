...
var Game = /** @class */ (function () {
    ...
    Game.prototype.addBlock = function () {
        ...
        // Interstitial at score 20: single attempt (STB)
        try{
            var currentScore = this.blocks.length - 1;
            if (!window.__stb_midrollShown && currentScore === 20) {
                window.__stb_midrollShown = true;
                if (typeof showAd === 'function' && typeof isAdReady !== 'undefined' && isAdReady === true) {
                    showAd();
                    console.log("Tower Blocks STB: Interstitial shown at score 20");
                } else if (typeof cacheAd === 'function') {
                    cacheAd();
                    console.log("Tower Blocks STB: Interstitial not ready at score 20, caching once");
                }
            }
        }catch(e){}
