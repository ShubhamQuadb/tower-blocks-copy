...
var Game = /** @class */ (function () {
    ...
    Game.prototype.startGame = function () {
        if (this.state != this.STATES.PLAYING) {
            ...
            if (typeof cacheAd === 'function') {
                cacheAd();
                console.log("Tower Blocks: Caching midroll ad");
            }
    ...
    Game.prototype.addBlock = function () {
        ...
        // Update score before adding new block
    ...
    Game.prototype.endGame = function () {
        ...
        //     console.log("Tower Blocks: Score posted to SDK - " + finalScore);
        // }
        ...
        //     setTimeout(function() {
        //         showAd();
        //         console.log("Tower Blocks: Showing midroll ad");
        //     }, 500);
        // }
...
//     getUserProfile();
//     console.log("Tower Blocks: getUserProfile() called");
// }
...
//     setTimeout(function() {
//         gameCacheAd();
//         console.log("Tower Blocks: gameCacheAd() called - Ads caching started");
//     }, 2000);
// }
